        ...
        <div className="relative">
          ...
          <div className="grid md:grid-cols-4 gap-8 relative">
            {steps.map((step, index) => (
              ...
              >
                <div
                  className={`w-20 h-20 mx-auto rounded-full flex items-center justify-center text-2xl font-bold mb-4 transition-all duration-500 ${
                    index <= activeStep
            ...
            {testimonials.map((testimonial, index) => (
              <div
                ...
                className={`transition-all duration-500 ${
                  current === index ? 'opacity-100 translate-x-0' : 'opacity-0 absolute inset-0 translate-x-8'
                }`}
              >
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all duration-300 ${
                  current === index ? 'bg-[#FF851B] w-8' : 'bg-gray-600'
                }`}
              />
            ))}
          </div>
          ...
          {faqs.map((faq, index) => (
            <div key={index} className="glassmorphic overflow-hidden">
              ...
              >
                ...
                <span
                  className={`transition-transform duration-300 text-[#FF851B] ${
